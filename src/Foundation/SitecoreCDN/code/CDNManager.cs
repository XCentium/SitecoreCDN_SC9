...
namespace SitecoreCDN
{
    ...
    public static class CDNManager
    {
        ...
        /// </summary>
        public static CDNProvider Provider => _provider;

        public static string StopToken => _provider.StopToken;
        ...
        public static void ReplaceMediaUrls(CQ doc)
        {
